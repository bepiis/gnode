...
requires
    writable_engine<Egn>
struct view_lookup<Egn, matrix_view::transpose> : public std::true_type
{
    using type = matrix_view::transpose;
...
private:
    ...
    using self_type = matrix_view_engine<Egn, matrix_view::transpose>;
