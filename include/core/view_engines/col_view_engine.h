...
requires 
    writable_engine<Egn>
struct matrix_view_engine<Egn, matrix_view::col>
{
...
private:
    ...
    using self_type = matrix_view_engine<Egn, matrix_view::col>;
...
public:
    ...
    explicit
    constexpr matrix_view_engine(engine_type & rhs, index_type col = 0)
