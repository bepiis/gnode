...
requires 
    readable_engine<Egn>
struct matrix_view_engine<Egn, matrix_view::const_col>
{
...
private:
    ...
    using self_type = matrix_view_engine<Egn, matrix_view::const_col>;
...
public:
    ...
    explicit
    constexpr matrix_view_engine(engine_type const& rhs, index_type col = 0)
