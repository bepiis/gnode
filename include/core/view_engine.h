...
requires
    base_types<TLHS> and
    base_types<TRHS> and
    engine_has_invocable_elements<TLHS, typename TRHS::data_type>
struct product_invocable<TLHS, TRHS> : std::true_type
{
    using TOP = TLHS;
    using TIN = TRHS;
    using data_type = std::invoke_result_t<typename TOP::data_type, 
...
requires
    base_types<TLHS> and
    base_types<TRHS> and
    engine_has_invocable_elements<TRHS, typename TLHS::data_type>
struct product_invocable<TLHS, TRHS> : std::true_type
{
    using TOP = TRHS;
    using TIN = TLHS;
 ...
 * 
 */
#include "view_engines/inner_product_view.h"
